...
OpenClaw 的核心定位确实是**个人 AI 助理**，但"个人"和"企业"的边界正在模糊。许多开发者在企业环境中使用 OpenClaw 完成个人工作流自动化，而非替代企业级系统。如果你在企业中使用，务必注意：最小权限原则、沙箱隔离、数据安全（详见[第十章安全加固](/cn/adopt/chapter10/)）。
...
1. **第一个必装技能是 skill-vetter**（安全扫描工具），详见[第六章](/cn/adopt/chapter6/)
2. 生产环境务必做安全加固（最小权限、网络隔离），详见[第十章](/cn/adopt/chapter10/)
