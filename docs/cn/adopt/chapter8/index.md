...
简单来说，个人助理就像一个"管家"：它通过**消息渠道**和你沟通（飞书/Telegram），用**技能**帮你操作各种工具（邮件、日历），按**定时任务**主动工作，并通过**记忆**记住你的偏好。
...
> **什么是 SOUL.md？** 这是一个文本文件，用来告诉 OpenClaw "你是谁、你该怎么做"。就像给新员工的入职须知。文件放在工作区根目录。
...
长期记忆存储你的偏好和信息。MEMORY.md 就像你给助理的"备忘录"，让它记住你的常用信息，不用每次都重复说：
